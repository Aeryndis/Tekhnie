...
public final class QueryUtils {
    ...
    /**
     * Query the USGS url and return an {@link Article} object to represent a single news article.
     */
     ...
     * about the first news article from the input articleJSON string.
     */
    private static List<Article> extractFeatureFromJson(String articleJSON) {
        ...
        try {
            ...
            JSONArray articleArray = baseJsonResponse.getJSONObject("response")
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                // Extract the fields object to get the byline key
                JSONObject fields = currentArticle.getJSONObject("fields");
                String byline = fields.getString("byline");

                // Create a new {@link Article} object with the article name, section ID, date
                // published, byline and url from the JSON response.
                Article article = new Article(title, byline, section, date, url);
